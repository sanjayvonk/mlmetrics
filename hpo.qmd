...
for bracket in brackets:
    ax.text(0.15, bracket["y"], bracket["label"], ha="left", va="center", fontsize=11, fontweight="bold")
    prev_x = None
    prev_y = None
    for xpos, count, budget in zip(stage_x, bracket["counts"], bracket["budget"]):
        ...
        ax.add_patch(patch)
        ax.text(xpos, bracket["y"] + 0.10, f"{count} configs", ha="center", va="center", fontsize=10)
...
ax.text(6.0, 0.55, "Moving right: fewer configurations receive more resources.", ha="center", fontsize=10)
